(() => {
  ...
  document.addEventListener('click', event => {
    ...
    if (infoButton) {
      closeNavigation();
      $('#info-content').innerHTML = infoButton.dataset.info === 'about' ? `<p class="small-label">OM TUMAC</p><h2 id="info-title">Utrustning med<br>ett tydligt jobb.</h2><p>Tumacs sortiment omfattar pumpar, blandare, hissar och lyftutrustning för bygg och industri. Här kan du hitta produktinformation och dokument för att komma vidare med ditt projekt.</p><p>Den befintliga webbplatsen beskriver egen maskindesign och tillverkning i Järfälla. Kontakta Tumac för aktuellt sortiment, speciallösningar och uthyrning.</p><button class="button yellow" data-contact>Prata med oss <span aria-hidden="true">↗</span></button>` : `<p class="small-label">DESIGNFÖRSLAG</p><h2 id="info-title">En ny webbplats<br>för Tumac.</h2><p>Det här är en lokal, klickbar prototyp. Produktbilder och dokument kommer från <a href="https://www.tumac.se/" target="_blank" rel="noopener">tumac.se</a>. Katalogen visar ett urval av sortimentet.</p><p>Huvudbilden är en AI-bearbetad presentationsbild med MP85 som utgångspunkt. Miljön är illustrativ. Produktbilderna i katalogen är originalbilder.</p><p>Sökning, kategorier, produktvyer och PDF-länkar fungerar. Kontaktflödet skapar ett lokalt e-postutkast; inget skickas automatiskt och inga formuläruppgifter lagras på en server.</p><p>Inför lansering behöver Tumac godkänna texter, bilder, kontaktuppgifter och aktuella produktdata. Webbplatsen är förberedd som vanliga webbfiler för Loopia.</p>`;
